...
//    private final static Logger logger = getLogger(SimpleProducer.class);
    ...
    public static void main(String[] args) throws ExecutionException, InterruptedException {
        ...
        String messageValue = "hi my name is hyunjun3";
        ProducerRecord<String, String> record_ = new ProducerRecord<>(TOPIC_NAME, messageValue);

        producer.send(record_ , new ProducerCallback());
